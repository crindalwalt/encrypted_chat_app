            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    leading: InkWell(
                      onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => UserProfileScreen(
                        userName: 'Friend Name $index',
                        userImage: 'https://images.pexels.com/photos/14255377/pexels-photo-14255377.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                        userBio: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac nisl nec nunc ultricies luctus. Nullam nec ultricies nunc. Sed nec nunc ultricies, ultricies nunc nec, ultricies nunc.',
                        userFriends: [
                      ...
                      child: CircleAvatar(
                        backgroundImage: NetworkImage('https://images.pexels.com/photos/14255377/pexels-photo-14255377.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'),
                      ),
                    ),
